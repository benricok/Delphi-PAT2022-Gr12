  ...
  object tbcStaff: TPageControl
    ...
    object tabCourses: TTabSheet
      ...
      object cmbSelectCourse: TComboBox
        ...
        OnSelect = cmbSelectCourseSelect
      end
      ...
      object pnlcourses: TPanel
        ...
        object cmbFaculty: TComboBox
          Left = 512
          Top = 74
          Width = 278
          Height = 21
          TabOrder = 4
          TextHint = 'Select Faculty'
          Items.Strings = (
            'AgriSciences'
    ...
    object tabUserAdmin: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object btnUserUp: TBitBtn
          ...
          Caption = 'Up'
          TabOrder = 3
          OnClick = btnUserUpClick
        end
        object btnUserDown: TBitBtn
          Left = 545
          Top = 45
          Width = 75
          Height = 25
